...
ALLOWED_HOSTS = os.getenv(
    "ALLOWED_HOSTS",
    "localhost,127.0.0.1,rian-audio.onrender.com,rian-audio-immv.vercel.app,.vercel.app,testserver"
).split(",")
...
# Tell Django the request is HTTPS even behind Vercel/Render proxy
